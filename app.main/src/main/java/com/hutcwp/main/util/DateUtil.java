...
public class DateUtil {
    ...
    public static String getNowYYYYMMDD() {
        Calendar today = Calendar.getInstance();
        return DateUtils.dateToString(today.getTime(), "yyyy-MM-dd");
    }

    public static String getNowHHmmss() {
        Calendar today = Calendar.getInstance();
        return DateUtils.dateToString(today.getTime(), "HH:mm:ss");
    }

    public static long subTimeHHmmss(String t1, String t2) {
        return getHourByTimeHHmmss(t2) - getHourByTimeHHmmss(t1);
    }

    private static long getHourByTimeHHmmss(String t) {
